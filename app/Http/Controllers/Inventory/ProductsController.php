...
class ProductsController extends Controller
{
    ...
    public function show($id)
    {
        if (@$id) {
            ...
            return redirect()->route('products.index')->with('message', 'success|Product has been successfully changed the status');
        } else {
            return back();
        }
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('products.index')->with('message', 'success|Product has successfully updated');
    ...
    public function destroy(Product $product)
    {
        ...
        return redirect()->route('products.index')->with('message', 'success|Product has successfully deleted');
    }
}
