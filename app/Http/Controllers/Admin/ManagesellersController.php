    ...
    public function show($id)
    {
        if (@$id) {
            ...
            if (@$records) {
                ...
                return redirect()->route('managesellers.index')->with('message', 'success|Seller has been successfully active.');
            }
        } else {
            return redirect()->route('managesellers.index');
        }
    ...
    public function edit($id)
    {
        if (@$id) {
            ...
            if (@$records) {
                ...
                return redirect()->route('managesellers.index')->with('message', 'success|Seller has been successfully Blocked.');
            }
        } else {
            return redirect()->route('managesellers.index');
        }
