        ...
        <div class="content">
            <div class="page-inner">
                ...
                <div class="page-header">
                    <h4 class="page-title">Edit Shipper</h4>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{ route('shipper.update') }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                <label>Address</label>
                                <textarea name="address" class="form-control" placeholder="Address">{{$shipper->address}}</textarea>
                            </div>
                    </div>
