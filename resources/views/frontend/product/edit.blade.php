...
@section('content')
    <div class="col-md-9">
        <div class="formPrtt">
            <h2>{{ $page }}</h2>
            <form method="post" enctype="multipart/form-data" action="{{ route('product.updateupload') }}">
                @csrf
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="{{ $product->name }}" placeholder="Product Title"
                                class="form-control" />
                        </div>
                    </div>
                    <div class="col-sm-12">
                    ...
                    @if ($product->price_show == 1)
                            ...
                            <div class="form-group">
                                ...
                                <div class="radioprt">
                                    <div class="listitem-check">
                                        <input checked type="radio" class="product_price_show" name="product_price_show"
                                            value="1">
                        ...
                        @if ($product->price_fixed == 1)
                            ...
                            <div class="col-sm-6" id="fixed_price">
                                ...
                                <div class="radioprt">
                                    ...
                                    <div class="listitem-check">
                                        <input type="radio" id="range_show" class="product_fixed_price_show"
                                            name="product_fixed_price_show" value="0">
                                        <label onClick="">Price Range</label>
                                    </div>
                                    <div class="listitem-check">
                                        <input checked type="radio" id="fixed_show" class="product_fixed_price_show"
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input id="price_from" name="price_from" type="number"
                                            value="{{ $product->price_from }}" placeholder="0" min="0" step="any"
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="price_to" name="price_to"
                                            value="{{ $product->price_to }}" required placeholder="0" min="0" step="any"
                                            class="form-control price_check" />
                                        <span id="price_to_error" style="display: none;" class="text-danger">Price To must
                                            be
                            ...
                            <div id="fixed_price_section" class="col-sm-6" style="display:contents;">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="price_to" name="price_to_fixed"
                                            value="{{ $product->price_to }}" required placeholder="0" min="0" step="any"
                                            class="form-control price_check" />
                                        <span id="price_to_error" style="display: none;" class="text-danger">Price To must
                        ...
                        @else
                            ...
                            <div id="price_section" class="col-sm-6" style="display:contents;">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label>Price Too:<sup>*</sup></label>
                                        <input type="number" id="price_to" name="price_to"
                                            value="{{ $product->price_to }}" required placeholder="0" min="0" step="any"
                                            class="form-control price_check" />
                                        <span id="price_to_error" style="display: none;" class="text-danger">Price To
                                            must
                                            be greater or equal than Price From</span>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <div class="form-group">
                                            <label>Fixed Price :<sup>*</sup></label>
                                            <input type="number" id="price_to" name="price_to_fixed"
                                                value="{{ $product->price_to }}" required placeholder="0" min="0"
                    ...
                    @else
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="radioprt">
                                    <div class="listitem-check">
                                        <input type="radio" class="product_price_show" name="product_price_show" value="1">
                                        <label onClick="">Yes</label>
                                    </div>
                                    <div class="listitem-check">
                                        <input checked type="radio" class="product_price_show" name="product_price_show"
                        ...
                        <div id="price_section" class="col-sm-6" style="display:none;">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label>Price To:<sup>*</sup></label>
                                    <input type="number" id="price_to" name="price_to" value="{{ $product->price_to }}"
                                        required placeholder="0" min="0" step="any" class="form-control price_check" />
                                    <span id="price_to_error" style="display: none;" class="text-danger">Price To must
                                        be
                                        greater or equal than Price From</span>
                                </div>
                        ...
                        <div id="fixed_price_section" class="col-sm-6" style="display:none;">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Fixed Price :<sup>*</sup></label>
                                    <input type="number" id="price_to" name="price_to_fixed" value="{{ $product->price_to }}"
                                        required placeholder="0" min="0" step="any" class="form-control price_check" />
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <textarea name="description" rows="4" cols="50" class="form-control ckeditor"
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input name="meta_title" required="" type="text" value="{{ $product->meta_title }}"
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input name="meta_keywords" required="" type="text" value="{{ $product->meta_keywords }}"
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <textarea name="meta_description" required="" rows="4" cols="50" class="form-control ckeditor"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="file" name="single" id="gallery-photo-add" class="form-control" />
                            <div class="gallery">
                            ...
                            @foreach ($allimages as $img)
                                @if ($img->url != $product->image_url)
                                    <div id="previd{{ $img->id }}">
                                        ...
                                        <button type="button" class="btn btn-success btn-sm delete-image"
                ...
                <button class="btn margin20" type="submit">Update</button>
            </form>
        </div>
    </div>
