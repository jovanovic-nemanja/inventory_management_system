                            ...
                            <div>
                                ...
                                <table style="border-collapse:collapse;width:44%;margin-bottom:20px">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="font-size:12px;text-align:left;padding:7px">
                                                Date : {{ $record->created_at }} <br>
                                                Purchase Order: PO{{ $record->request_id }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <table
                                    ...
                                    <tfoot>
                                        ...
                                        @endif
                                        {{-- <tr>
                  <td style="font-size:12px;border-right:1px solid #264b72;border-bottom:1px solid #264b72;text-align:right;padding:7px" colspan="4"><b>SHIPPING:</b></td>
                  <td style="font-size:12px;border-right:1px solid #264b72;border-bottom:1px solid #264b72;text-align:right;padding:7px">{{$quotes[0]->shipping_weight * $quotes[0]->shipping_price * $quotes[0]->volume}}.00 {{$quotes[0]->currency_name}}</td>
                </tr> --}}
                                        {{-- @if ($quotes[0]->other_price > 0)
                    <tr>
                  <td style="font-size:12px;border-right:1px solid #264b72;border-bottom:1px solid #264b72;text-align:right;padding:7px" colspan="4"><b>OTHER:</b></td>
                  <td style="font-size:12px;border-right:1px solid #264b72;border-bottom:1px solid #264b72;text-align:right;padding:7px">{{ $quotes[0]->other_price }}.00 {{$quotes[0]->currency_name}}</td>
                </tr>
                @endif --}}
                                        <tr>
