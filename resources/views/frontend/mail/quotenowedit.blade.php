                                    ...
                                    <table width="92%" cellspacing="0" cellpadding="0" border="0" align="center"
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <p style="font-size: 16px; margin-bottom: 0;">Congratulations!</p>
                                                <p style="font-size: 16px; margin-bottom: 0; margin-top: 5px;">Your recent Quotation has been updated.
                                                </p>
                                                <p style="font-size: 16px; margin-top: 30px;">Please check the details and turn the quotation into an order.</p>
                                        ...
                                        <tr>
                                            <td bgcolor="#fbfbfb"
                                                ...
                                                <a href="<?= $product_link ?>" target="_blank">
                                                    <button
                                                        style="background: #d9534f; color: #fff; padding:10px 25px; border-radius: 10px; border:none; cursor: pointer;margin-left:36%;">
                                                        View Now
                                                    </button>
                                                </a>
