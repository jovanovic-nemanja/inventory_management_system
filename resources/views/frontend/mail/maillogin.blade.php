                            ...
                            <tr>
                                <td height="88" bgcolor="#FFFFFF" style="text-align:center; padding: 10px 0;">
                                    <a target="_blank" href="https://mambodubai.com" alt="" class="CToWUd">
                                        <img src="https://mambodubai.com/images/mail-images/logo.png" alt="#" />
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                <td style="font-family:Calibri;" align="center" bgcolor="#FFFFFF">
                                    <div style="position:relative;">
                                        <img src="https://mambodubai.com/images/mail-images/verify-banner.png" alt="#"
                                            width="100%" />


                                        <div
                                            style="position: absolute; left:50%; top: 35px; padding: 0 10px; transform: translateX(-50%); width: 100%;">
                                            <img src="https://mambodubai.com/images/mail-images/verify-icon.png"
                                                alt="#" />
                                            <p
                                                style="font-weight: bold; letter-spacing: 2px; font-size: 30px; color: #35820a; margin: 0;">
                                ...
                                <td bgcolor="#FFFFFF"
                                    ...
                                    <table width="92%" cellspacing="0" cellpadding="0" border="0" align="center"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="color:#231f20;">

                                                    <span style="height: 30px; display: block;">&nbsp;</span>
                                                    <a href="{{ $verify_link }}" target="_blank">
                                                        <button
                                                            style="background: #d9534f; color: #fff; padding:10px 25px; border-radius: 10px; border:none; cursor: pointer;magin-left:30%;">Verify
                                                            your account
                                                        </button>
                                                    </a>
                                            ...
                                            <tr>
                                                <td>
                                                    <div
                                                        style="background: #e5f8ff; padding: 8px 20px; border-radius: 10px; margin-left:33%;">
                                                        <span>
                                                            Thankyou for choosing MamboDubai.
                                                        </span>
                                                    </div>
                                                </td>
                                            </tr>
