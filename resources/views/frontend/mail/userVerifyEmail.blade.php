                        ...
                        <tbody>
                            ...
                            <tr>
                                <td height="88" bgcolor="#FFFFFF" style="text-align:center; padding: 10px 0;">
                                    <a target="_blank" href="https://mambodubai.com" alt="" class="CToWUd"><img
                                            src="https://mambodubai.com/images/mail-images/logo.png" alt="#" /></a>
                                </td>
                            </tr>
                            <tr>
                                <td style="font-family:Calibri;" align="center" bgcolor="#FFFFFF">
                                    <div style="position:relative;">
                                        <img src="https://mambodubai.com/images/mail-images/welcome-banner.png" alt="#"
                                            width="100%" />
                                        <div
                                            style="position: absolute; left:50%; top: 10px; padding: 0 20px; transform: translateX(-50%);">
                                            <p
                                                style="font-weight: bold; letter-spacing: 2px; font-size: 40px; text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.27); color: #fff;">
                                                Welcome to MamboDubai
                                            </p>
                                ...
                                <td bgcolor="#FFFFFF"
                                    ...
                                    <table width="92%" cellspacing="0" cellpadding="0" border="0" align="center"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <p style="font-size: 20px;"><strong>Hello <span
                                                                style="color: #df3762;">Customer
                                                                Name,</span></strong></p>
                                                    <p style="font-size: 16px;">Thank you for registering on Mambodubai.
                                                    </p>
                                                    <p style="font-size: 17px;"><strong>Just steps away from enjoying
                                                            services on this
                                                            website.</strong></p>

                                                    <button
                                                        style="background: #d9534f; color: #fff; padding:10px 25px; border-radius: 10px; border:none; cursor: pointer;">Complete
                                                        your profile</button>
                                                </td>
                                            </tr>
