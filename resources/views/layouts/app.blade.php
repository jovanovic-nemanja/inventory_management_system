...
<head>
    ...
    <meta name="title" content="@php
        echo ucfirst($__env->yieldContent('main_title'));
    @endphp">
    <meta name="keywords" content="@php
        echo ucfirst($__env->yieldContent('keywords'));
    @endphp">
    ...
    <title>
        @php
            echo ucfirst($general_setting->site_name);
        @endphp
    </title>
            ...
            <div class="top_header">
                <div class="container-fluid">
                    <div class="inner_upheader" style=" min-height:8px;">
                        {{-- <p>
                            <img src="{{ asset('newdesign/images/icon/welcome.png') }}" alt="icon" />We welcome you
                            to MamboDubai.com
                        </p> --}}
                    ...
                    <script type="text/javascript">
                        ...
                        $(function() {
                            ...
                            $('.infinite-scroll').jscroll({
                                autoTrigger: true,
                                loadingHtml: '<img style="margin-left:50%;" class="center-block" src="../images/loader.gif" alt="Loading..." />',
                                padding: 0,
                        ...
                        $(document).ready(function() {
                            ...
                            $("#reqSubmitBtn").click(function(e) {
                                ...
                                if (formData[2].value <= 0) {
                                    ...
                                    e.preventDefault();
                                    return false;
                                } else if (formData[2].value < minquantity) {
                                    $('#rQutaionError').html(
                                ...
                                $.ajax({
                                    ...
                                    data: {
                                        ...
                                        product_name: formData[5].value
                                    },
                                    success: function(data) {
                                        $("#reqSubmitBtn").attr("disabled", false);
                                        $("#reqSubmitBtn").text('Submit');
                                        $("#reqQutoFrm").trigger('reset');
                                        $('#reqQutoFrm').css('display', 'none');
                                        $('#requestSuccessTxt').css('display', 'contents');
                                    },
                                    error: function(XMLHttpRequest, textStatus, errorThrown) {
                                        $("#reqSubmitBtn").attr("disabled", false);
                                        $("#reqSubmitBtn").text('Submit');
                            ...
                            $("#successBtn").click(function(e) {
                                e.preventDefault();
                                $("#reqQutoFrm").css("display", "contents");
                            ...
                            $("#callbackSellerPrfleBtn").click(function(e) {
                                $.ajaxSetup({
                                    headers: {
                                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                                    }
                                ...
                                e.preventDefault();
                                var formData = $('#callbackSellerPrfleFrm').serializeArray();
                                console.log(formData);
                                var emailReg = /^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/;
                                if (formData[1].value == '') {
                                    $('#reqCallBackErrorPrf').html('Name is required.');
                                    $("#reqPrfName").focus();
                                    e.preventDefault();
                                    return false;
                                } else if (isNaN(formData[1].value) == false) {
                                    $('#reqCallBackErrorPrf').html('Name must be in Character.');
                                    $("#reqCallBackName").focus();
                                    e.preventDefault();
                                    return false;
                                } else if (formData[2].value == '') {
                                    $('#reqCallBackErrorPrf').html('Email is required');
                                    $("#reqPrfEmail").focus();
                                    e.preventDefault();
                                    return false;
                                } else if (!emailReg.test(formData[2].value)) {
                                    $('#reqCallBackErrorPrf').html('Email should be Valid.');
                                    $("#reqPrfEmail").focus();
                                    e.preventDefault();
                                    return false;
                                } else if (formData[3].value == '') {
                                    $('#reqCallBackErrorPrf').html('Mobile is required.');
                                    $("#reqPrfMobile").focus();
                                    e.preventDefault();
                                    return false;
                                } else if (!$.isNumeric(formData[3].value)) {
                                    $('#reqCallBackErrorPrf').html('Mobile no must be numeric.');
                                    $("#reqPrfMobile").focus();
                                    e.preventDefault();
                                    return false;
                                }
                                ...
                                $.ajax({
                                    ...
                                    data: {
                                        ...
                                        mobile: formData[3].value,
                                        message: formData[4].value,
                                        customer_id: formData[5].value,
                                        product_id: formData[6].value,
                                    },
                                    success: function(data) {
                                        $("#callbackSellerPrfleFrm").trigger('reset');
                                        $('#reqCallBackSuccesPrf').html('Thank you for submitting request');
                                    },
                                    error: function(XMLHttpRequest, textStatus, errorThrown) {
                                        var msg = JSON.parse(XMLHttpRequest.responseText);
                                        console.log(msg);
                            ...
                            $(".msgcls").click(function(e) {
                                $('#reqCallBackErrorPrf').html('');
                                $('#reqCallBackSuccesPrf').html('');
                            });
                        });
                        ...
                        $("#submitRegister").on('click', function(event) {
                            ...
                            if (first_name == '') {
                                ...
                                $('#first_name').closest('.form-group').find('.error').html(
                                    '**First Name must be in Character.');
                                $("#first_name").focus();
                                event.preventDefault();
                                return false;
