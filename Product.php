...
class Product extends Model {
    ...
    public $fillable = ['name', 'meta_title', 'meta_keywords','video_link', 'meta_description', 'MOQ', 'quantity', 'description', 'user_id', 'price_from', 'price_to', 'price_show', 'category_id', 'currency_id', 'unit', 'image_url', 'slug', 'sign_date', 'username', 'status'];
